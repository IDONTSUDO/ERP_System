const Direct = require("../database/Company/Company");
const UserStatistic = require("../database/Statistics/UserStatistic");
const UserDevice = require("../database/User/Devises");
const UserSecurity = require("../database/User/Security");
const UserNews = require("../database/User/News");
...
exports.signin = (req, res, next) => {
  ...
  Direct.findOne({ email }, (err, direct) => {
    ...
    const token = jwt.sign(
      { _id: direct._id, name: direct.name },
