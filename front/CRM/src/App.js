...
/* -------------------------------- П.Р.О.Л.О.Г.  --------------------------------//
Братишка, ты наверное искать приключений раз решил посмотреть, этот проект.
То что ты здесь увидешь это очень дерьмовый код.
И такой скажешь а зачем ты пишешь дерьмово? А я тебе отвечу, красивые проекты не взлетают.
Потому что они не успевают взлететь. Пока инженеры в белых халатх, прикручивают красивый 
...
работа в том что бы делать программыы которые работают.
//----------------------------------  --------------------------------*/
