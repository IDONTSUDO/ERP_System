                            ...
                            <Card
                              ...
                              actions={[
                                <Icon
                                  ...
                                  twoToneColor="#eb2f96"
                                  onClick={DealId =>
                                    this.helperDeal(oneDeal._id, DealId)
                                  }
                                />,
                                <Icon
                                  type="edit"
                                  key="edit"
                                  onClick={DealId =>
                                    this.showModal(oneDeal._id, DealId)
                                  }
                                  theme="twoTone"
                                  twoToneColor="#37CBC1"
                                />,
                                <Icon
                                  ...
                                  theme="twoTone"
                                  onClick={DealId =>
                                    this.ChangeHistoryStatusActive(
                                      oneDeal._id,
                                      DealId
                                    )
                                  }
                            ...
                            <Card
                              ...
                              actions={[
                                ...
                                <Icon
                                  ...
                                  theme="twoTone"
                                  onClick={DealId =>
                                    this.ChangeHistoryStatusComplete(
                                      oneDeal._id,
                                      DealId
                                    )
                                  }
                ...
                <div className="col-md-4">
                  <div className="">
                    <div className="">
                      ...
                      <div className="">
                        Статус сделки: <b>{StatusOne}</b>{" "}
                      </div>
                      <div className="">
                        Названиие сделки: <b>{OneName}</b>{" "}
                      </div>
                      <div className="">{comment}</div>
                      <div className="">
                        Предмет сделки: <b>{ItemOne}</b>{" "}
                      </div>
                    </div>
                  </div>
                  <div style={{ padding: "10px" }}>
                    <Button
                      type="primary"
                      onClick={agent => this.helperAgent(AgentId, agent)}
                    >
                  ...
                  <div style={{ padding: "10px" }}>
                    <Button
                      type="primary"
                      onClick={agent => this.helperAgentHystory(AgentId, agent)}
                    >
                      Все сделки
                    </Button>
                  </div>
                  ...
                  {company !== "" ? (
                    <>
                      <div className="layer-list-agent">
                        ...
                        <div>
                          Короткое имя компании:<b>{name}</b>
                        </div>
                        <div>
                          Полное имя:<b>{full_name}</b>
                        </div>
                        <div>
                          Телефон:<b>{phone}</b>
                        </div>
                        ...
                        <div>
                          Генеральный директор:<b>{general_director}</b>
                        </div>
                        <div>
                          ОГРН:<b>{OGRN}</b>
                        </div>
                        ...
                        <div>
                          Полезная информация:<b>{any}</b>
                        </div>
                        <div>
                          Адрес:<b>{legal_address}</b>
                        </div>
                        <div>
                          Фактический адрес:<b>{actual_address}</b>
                        </div>
                        <div>
                          Расчетный счет:<b>{payment_account}</b>
                        </div>
                      </div>
                    </>
                  ) : (
        ...
        >
          <form>
            ...
            <div className="form-group">
              ...
              <input
                onChange={this.handleChange("ItemOne")}
                type="text"
                className="form-control"
                value={ItemOne}
              />
