    ...
    render() {
        ...
        return (
            <div className="postisitonRelativeSmeni">
                ...
                {page > 1 ? (
                    <>
                      <Button  onClick={() => this.loadLess(1)} className="ButtonPaginate" icon="left"></Button>  
                    </>
                ):("")}
                {history.length   ? (
                    <>
                       <Button  onClick={() => this.loadMore(1)} className="ButtonPaginate" icon="right"></Button>
                    </>
                ):("")}
                ...
                {history.map((oneDeal, i) => (
                    <>
                        <Card style={{backgroundColor:"#996BD5"}}> 
                            ...
                            <Moment  style={{color:"#FEFEFE"}} format="D MMM YYYY">{oneDeal.Date}</Moment>
                        </Card>
                    </>))}
