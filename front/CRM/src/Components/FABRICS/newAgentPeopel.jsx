		...
		return (
			<div>
				...
				<Input
					...
					size="large"
					id={`HumanPosition${fabricState}`}
					className="input_new_agent "
					placeholder="Должность:"
				/>
				<p className="input_new_agent agentnew_front">Особености работы</p>
				<TextArea
					value={this.state.HumanFeatures_job}
					onChange={this.handleChange('HumanFeatures_job')}
				...
				<TextArea
					value={this.state.HumanCommon}
					onChange={this.handleChange('HumanCommon')}
					size="large"
					id={`HumanCommon${fabricState}`}
					className="input_new_agent "
					placeholder="почта:"
				/>
			</div>
