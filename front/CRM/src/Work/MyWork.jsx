    ...
    return (
      <div style={{overflowY:"scroll" }} className="job-main-content">
        <Tabs defaultActiveKey="1">
          ...
          {open === true ? (<><Spin size="large"/></>):(
          <>
          
          <ui>
              <div className="container_button_job">
                <Button
                  onClick={() => this.yellowSort(this.state.yellowTodoDisplay)}
                  className="square-yellow"
                ></Button>
                <Button
                  onClick={() => this.greenSort(this.state.greenTodoDisplay)}
                ...
                {todos.map((comTodo, i) => (
                  <>
                    {comTodo.JobArray.length === 0 ? (
                      <>
                        {moment().diff(moment(comTodo.diff[0]), "days") <= 0 ? (
                          <>
                              ...
                              <>
                                ...
                                >
                                  <Card className="todo-green">
                                    ...
                                    >
                                      {this.renderImortance(comTodo.importance)}
                                    </div>
                                    <h5 style={{ color: "#ffffff", wordBreak: "break-word"  }}>
                                      {comTodo.title}
                                    </h5>
                                    ...
                                    {comTodo.status === "system" ? (
                                      ...
                                      <>
                                        <Popover
                                          ...
                                          content={
                                            <>
                                              {this.renderPopoverSolo(comTodo)}
                                            </>
                                          }
                                          title="Задача"
                                        >
                              ...
                              <>
                                ...
                                >
                                  <Card className="todo-yellow">
                                    ...
                                    <h5 style={{ color: "rgb(0, 0, 0)", wordBreak: "break-word" }}>
                                      {comTodo.title}
                                    </h5>
                                  ...
                                  {comTodo.status === "system" ? (
                                    <>
                                      <Popover
                                        ...
                                        content={
                                          <>
                                            {this.renderPopoverSystem(comTodo)}
                                          </>
                                        }
                                        title="Задача"
                                      >
                                      ...
                                      <>
                                        ...
                                        >
                                          <Card className="todo-yellow">
                                            ...
                                            <h5
                                              style={{ color: "rgb(0, 0, 0)", wordBreak: "break-word" }}
                                            >
                                              {comTodo.title}
                                            </h5>
                                            <div
