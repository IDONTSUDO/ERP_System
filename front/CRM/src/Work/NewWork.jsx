...
class Work extends React.Component {
  ...
  /*
  И вот здесь ты скажешь мне то это полный костыль,
...
// Full name
// position
// if (worker === "workerJob0") {
//   var { workerJob0 } = this.state;
//   console.log(workerJob0)
//   let result = workerJob0.indexOf(selObj);
//   let editText = workerJob0.substr(0, result) + "`" +  workerJob0.substring([result], workerJob0.length) + "`";
//   console.log(editText)
//   this.setState({ workerJob0: editText });
// }
// if (worker === "workerJob1") {
//   var { workerJob1 } = this.state;

//   let result = workerJob1.indexOf(selObj);
//   let editText =
//     workerJob1.substr(0, result) +
//     "`" +
//     workerJob1.substring([result], workerJob1.length) +
//     "`";
//   this.setState({ workerJob1: editText });
// }
// if (worker === "workerJob2") {
//   var { workerJob2 } = this.state;

//   let result = workerJob2.indexOf(selObj);
//   let editText =
//     workerJob2.substr(0, result) +
//     "`" +
//     workerJob2.substring([result], workerJob2.length) +
//     "`";
//   this.setState({ workerJob2: editText });
// }
// if (worker === "workerJob3") {
//   var { workerJob3 } = this.state;

//   let result = workerJob3.indexOf(selObj);
//   let editText =
//     workerJob3.substr(0, result) +
//     "`" +
//     workerJob3.substring([result], workerJob3.length) +
//     "`";
//   this.setState({ workerJob3: editText });
// }
// if (worker === "workerJob4") {
//   var { workerJob4 } = this.state;

//   let result = workerJob4.indexOf(selObj);
//   let editText =
//     workerJob4.substr(0, result) +
//     "`" +
//     workerJob4.substring([result], workerJob4.length) +
//     "`";
//   this.setState({ workerJob4: editText });
// }
// if (worker === "workerJob5") {
//   var { workerJob5 } = this.state;

//   let result = workerJob5.indexOf(selObj);
//   let editText =
//     workerJob5.substr(0, result) +
//     "`" +
//     workerJob5.substring([result], workerJob5.length) +
//     "`";
//   this.setState({ workerJob5: editText });
// }
// if (worker === "workerJob6") {
//   var { workerJob6 } = this.state;

//   let result = workerJob6.indexOf(selObj);
//   let editText =
//     workerJob6.substr(0, result) +
//     "`" +
//     workerJob6.substring([result], workerJob6.length) +
//     "`";
//   this.setState({ workerJob6: editText });
// }
// if (worker === "workerJob7") {
//   var { workerJob7 } = this.state;

//   let result = workerJob7.indexOf(selObj);
//   let editText =
//     workerJob7.substr(0, result) +
//     "`" +
//     workerJob7.substring([result], workerJob7.length) +
//     "`";
//   this.setState({ workerJob7: editText });
// }
// if (worker === "workerJob8") 
// {
//   var { workerJob8 } = this.state;
//   let result = workerJob8.indexOf(selObj);
//   let editText =
//     workerJob8.substr(0, result) +
//     "`" +
//     workerJob8.substring([result], workerJob8.length) +
//     "`";
//   this.setState({ workerJob8: editText });
// }
// if (worker === "workerJob9") 
// {
//   var { workerJob9 } = this.state;
//   let result = workerJob9.indexOf(selObj);
//   let editText =
//     workerJob9.substr(0, result) +
//     "`" +
//     workerJob9.substring([result], workerJob9.length) +
//     "`";
//   this.setState({ workerJob9: editText });
// }