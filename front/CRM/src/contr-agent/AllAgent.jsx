            ...
            {page > 1 ? (
                ...
                {agent.length ? (
                    ...
                    ""
                                   ...
                                   <Button   type="primary" icon="search" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
                    Поиск контр агентов
                  </Button>
            {/* <!-- Modal --> */}
            <div style={ style } class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div className="search-position">

                <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <input onChange={this.handleChange("item")}value={item}  type="text" class="form-control" placeholder="Поиск ..." aria-label="Recipient's username" aria-describedby="basic-addon2"/>
