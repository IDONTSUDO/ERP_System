...
export const ContrAgentDontManage = (page) => {
	return fetch(`${process.env.REACT_APP_API_URL}/agent/dont/manage/?page=${page}`, {
		method: 'GET',
		headers: myHeaders
	})
		.then((response) => {
...
export const CompanyAllRole = () => {
	return fetch(`${process.env.REACT_APP_API_URL}/all/role`, {
		method: 'GET',
		headers: myHeaders
	})
		.then((response) => {
...
export const CompanyDeleteRole = (payload) => {
	return fetch(`${process.env.REACT_APP_API_URL}/delete/role`, {
		method: 'POST',
		headers: myHeaders,
		body: JSON.stringify(payload)
	})
...
export const CompanyNewRole = (userId) => {
	return fetch(`${process.env.REACT_APP_API_URL}/new/role`, {
		method: 'POST',
		headers: myHeaders,
		body: JSON.stringify(userId)
	})
...
export const NewCompanyStructures = (structures) => {
	let payload = { structures };
	return fetch(`${process.env.REACT_APP_API_URL}/new/company/structures`, {
		method: 'POST',
		headers: myHeaders,
		body: JSON.stringify(payload)
	})
...
export const GetCompanySturctures = () => {
	return fetch(`${process.env.REACT_APP_API_URL}/company/strutures`, {
		method: 'GET',
		headers: myHeaders
	})
		.then((responce) => {
