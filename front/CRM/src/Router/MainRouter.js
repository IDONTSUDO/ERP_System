...
const MainRouter = () => (
  <div>
    ...
    <Switch>
      ...
      <PrivateRoute
        exact
        path="/agent/priced/:agentId"
        component={ManageAgentPrice}
      />
      <PrivateRoute exact path="/agent/tasks/:agentId" component={AgentTasks} />
      <PrivateRoute
        exact
        path="/agent/task/:agentId/:month/:year"
        component={AgentTask}
      />
      ...
      <PrivateRoute
        exact
        path="/todo/assign/user/:userBy"
        component={TodoAssignUserBy}
      />
      <PrivateRoute exact path="/new/deal/:userId" component={NewDeal} />
      <PrivateRoute
        exact
        path="/my/assign/task/:userId"
      ...
      <PrivateRoute
        exact
        path="/my/deal/history/:userId"
        component={MyDealHistory}
      />
      <PrivateRoute
        exact
        path="/agent/history/:agentId"
        component={AgentHistory}
      />
      <PrivateRoute
        exact
        path="/agent/edit/:agentId"
        component={EditContrAgent}
      />
